		...
		<div class="row">
			<table class="table-striped col-md-6">
				...
				<tr>
					...
					<td class="w-50"><?= $product_first_version->product_name ?></td>
				</tr>
				<tr>
					<th class="w-50">Ürün Tipi</th>
					<td class="w-50"><?= $product_first_version->product_type ?></td>
				</tr>
				<tr>
					<th class="w-50">Parça Tipi</th>
					<td class="w-50"><?= $product_first_version->part_type ?></td>
				</tr>
				<tr>
